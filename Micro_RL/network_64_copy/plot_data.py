"""
Learning curve — singolo gruppo MCU (on-device).

Carica learning_curve{1..N}.csv dalla stessa cartella e mostra
...
CSV_PATTERN = "learning_curve{i}.csv"   # file MCU on-device
REWARD_COL  = "reward"
...
# ------------------------------------------------------------------ #
TITLE       = "MCU on-device learning curve"
SHOW_TITLE  = True
TITLE_PAD   = 54
CURVE_LABEL = "MCU (on-device)"
LEGEND_Y    = 1.02
